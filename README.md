...
<!-- 2. Users should be able to see the profile page of a blogger. On this page, a user should see:
	...
	- **BONUS** A link to that blogger's featured post (the post with the most likes)
...
<!-- 1. Users should be able to see a destination profile page. On this page, a user should see:
	- All posts written about this destination  -->
	- **BONUS** only top 5 posts
	- **BONUS** A link to a featured post (this destination's post with the most likes)
	- **BONUS** The average age of all unique bloggers who have written about this destination.
